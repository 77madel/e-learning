                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0 pt-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-12 mb-3 mb-md-0">
                                        <a href="#">
                                            <img src="{{ asset("assets/images/course/course-laravel.jpg")}}" alt="" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <!-- Col -->
                            ...
                            <li class="list-group-item px-0">
                                <div class="row">
                                    <div class="col-md-3 col-12 mb-3 mb-md-0">
                                        <a href="#"><img src="{{ asset("assets/images/course/course-gatsby.jpg")}}" alt="" class="img-fluid rounded"></a>
                                    </div>
                                    <div class="col-md-8 col-10">
                                        <a href="#">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row">
                                    <div class="col-md-3 col-12 mb-3 mb-md-0">
                                        <a href="#">
                                            <img src="{{ asset("assets/images/course/course-javascript.jpg")}}" alt="" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-md-8 col-10">
                                        <a href="#">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row">
                                    <div class="col-md-3 col-12 mb-3 mb-md-0">
                                        <a href="#">
                                            <img src="{{ asset("assets/images/course/course-wordpress.jpg")}}" alt="" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-md-8 col-10">
                                        <a href="#">
